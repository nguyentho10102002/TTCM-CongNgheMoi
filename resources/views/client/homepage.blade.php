                ...
                <div class="row align-items-center">
                    <div class="col-md-6 d-none d-md-block">
                        <div class="header-top-subs">
                            <p>Công Ty Cổ Phần <span>TH</span></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="banner-content">
                                    <h6 class="sub-title" data-animation="fadeInUp" data-delay=".2s">TH</h6>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="copyright-text">
                            <p>Copyright &copy;  @php echo date('Y') @endphp . All Rights Reserved By <a href="/assets_client/index.html">TH</a></p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
